...
public class AlbumImageView extends ImageView {
    ...
    private static final int SHADOW_ELEVATION = 24;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mMiddleRect = new RectF(0, 0, middleRectSize, middleRectSize);
        mInnerRect = new RectF(0, 0, innerRectSize, innerRectSize);
        mAlbumPathRect = new RectF(0, 0, albumRectSize, albumRectSize);
